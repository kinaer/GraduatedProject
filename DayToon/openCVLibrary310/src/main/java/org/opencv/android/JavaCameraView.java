...
public class JavaCameraView extends CameraBridgeViewBase implements PreviewCallback,Camera.FaceDetectionListener {
    ...
    private Toast tt = Toast.makeText(getContext()," ",Toast.LENGTH_SHORT);
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    if(getResources().getConfiguration().orientation != Configuration.ORIENTATION_LANDSCAPE && mCameraIndex == Camera.CameraInfo.CAMERA_FACING_FRONT)
